...
type BloodSugarRepository interface {
	...
	GetDistributionForPuskesmas(ctx context.Context, puskesmasID string) (*GlucoseDistributionResponse, error)
}
...
type BloodSugarService interface {
	...
	GetPuskesmasDashboard(ctx context.Context, puskesmasID string) (*GlucoseDistributionResponse, error)
}
